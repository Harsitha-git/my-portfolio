    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg">
            Throughout my career, I have had the opportunity to work on diverse projects and collaborate with talented teams. Here is a glimpse into my professional journey:
          </p>
        </div>
        <div className="mb-4">
